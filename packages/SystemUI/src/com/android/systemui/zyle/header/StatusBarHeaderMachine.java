...
package com.android.systemui.zyle.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.zyle.header.STATUS_BAR_HEADER_UPDATE";
